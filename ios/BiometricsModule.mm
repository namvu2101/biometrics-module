...
@implementation BiometricsModule
RCT_EXPORT_MODULE()

- (std::shared_ptr<facebook::react::TurboModule>)getTurboModule:
(const facebook::react::ObjCTurboModule::InitParams &)params {
  return std::make_shared<facebook::react::NativeBiometricsModuleSpecJSI>(params);
}

- (void)authenticate:(JS::NativeBiometricsModule::authenticateProps &)value
...
- (void)authenticateWithKey:(JS::NativeBiometricsModule::authenticateWithKeyProps &)value
                    resolve:(RCTPromiseResolveBlock)resolve
                     reject:(RCTPromiseRejectBlock)reject {
...
- (void)checkAvailableBiometrics:(RCTPromiseResolveBlock)resolve
                          reject:(RCTPromiseRejectBlock)reject {
...
- (void)getAvailableBiometrics:(RCTPromiseResolveBlock)resolve
                        reject:(RCTPromiseRejectBlock)reject {
  LAContext *context = [[LAContext alloc] init];
  NSError *error = nil;
...
- (void)setSecretValue:(JS::NativeBiometricsModule::TSecretValue &)props
               resolve:(RCTPromiseResolveBlock)resolve
                reject:(RCTPromiseRejectBlock)reject {
  LAContext *context = [[LAContext alloc] init];
  NSError *error = nil;
